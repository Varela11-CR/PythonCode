...
# 'I' is paid yearly, and the new sum is re-invested 
# yearly after paying tax 'T' on the interests that were 
# just gained (and only on the interests part).
...
# take into consideration that if the Desired Principal 'D' 
...
def calculate_years(principal, interest, tax, desired):
    ...
    while principal < desired:
        ...
        waste = profit * tax
        principal = principal + (profit - waste)
